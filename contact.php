...
<section style="margin-top:30px" class="contact" id="contact">
   <div class="container contact_container">
      ...
      <h2>Contact Us</h2>
      <p>
      We value your opinion! Help us improve your experience on TechBuzz by sharing your feedback. . 
      </p>
   ...
   <form action="https://formspree.io/f/xjkpyepq" class="contact_form" method="POST">
      <div class="form_name">
      ...
      <button type="submit" class="btn btn-primary" name="submit"  style="background-color: rgb(37,17,189); border-radius: 10px;">Send Message</button>
   </form>
   </div>
</section>  
